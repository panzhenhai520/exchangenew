export default {
  ...
  system_maintenance: {
    ...
    branch_management: {
      ...
      company_full_name_placeholder: '请输入公司全称（用于收据）',
      company_full_name_help: '该名称将显示在交易收据的抬头',
      tax_registration_number: '税务登记号',
      tax_registration_number_placeholder: '请输入税务登记号',
      tax_registration_number_help: '该编号将显示在交易收据上',
      institution_type: '机构类型',
      institution_type_help: '该类型用于AMLO反洗钱报告',
      institution_types: {
        money_changer: '货币兑换商',
        bank: '银行',
      ...
      website: '公司网址',
      website_placeholder: '请输入公司网址',
      website_help: '例如：www.example.com',
      license_number: '许可证编号',
      license_number_placeholder: '请输入许可证编号',
      license_number_help: '营业执照或经营许可证编号',
      amlo_institution_code: 'AMLO机构代码',
      amlo_institution_code_help: '央行分配的3位数字，用于AMLO报告第一组小框',
      amlo_branch_code: 'AMLO网点代码',
      amlo_branch_code_help: '报告使用的3位网点编号，对应第二组小框',
      bot_sender_code: 'BOT报送机构代码',
      bot_sender_code_help: '填写BOT模板中“รหัสสถาบันผู้ส่งข้อมูล”字段，通常为13位数字',
      bot_branch_area_code: 'BOT营业区域代码',
      bot_branch_area_code_help: '对应BOT模板的“เลขที่ 或รหัสพื้นที่ของสถานประกอบการ”字段',
      bot_license_number: 'BOT许可证编号',
      bot_license_number_help: '如BOT模板单独要求的License No，可与AMLO编号区分',
      status: {
        active: '活动',
        inactive: '停用'
      },
