                      ...
                      <div class="row g-2 align-items-end">
                        ...
                        <div class="col-lg-4 col-md-6">
                          ...
                          <select
                            ...
                            class="form-select form-select-sm"
                          >
                            <option value="cash">{{ $t('transaction.cash') }}</option>
                            <option value="bank_transfer">{{ $t('transaction.bankTransfer') }}</option>
                            <option value="fcd_account">{{ $t('transaction.fcdAccount') }}</option>
                          </select>
                          <!-- 普通输入 -->
                          <input
                            v-else
...
export default {
  ...
  setup() {
    ...
    const getFieldPlaceholder = (field) => {
      if (field.includes('amount') || field === 'usd_equivalent') {
