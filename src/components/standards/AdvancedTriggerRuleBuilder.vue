        ...
        <div class="row g-2">
          ...
          <div class="col-md-5">
            ...
            >
              ...
              <option value="bank_transfer">{{ $t('standards.trigger.bank_transfer') }}</option>
              <option value="fcd_account">{{ $t('standards.trigger.fcd_account') }}</option>
              <option value="other">{{ $t('standards.trigger.other') }}</option>
            </select>
