export default {
  system_maintenance: {
    ...
    branch_management: {
      ...
      company_full_name: 'ชื่อบริษัทเต็ม',
      company_full_name_placeholder: 'กรุณาใส่ชื่อบริษัทเต็ม (สำหรับใบเสร็จ)',
      company_full_name_help: 'ชื่อนี้จะแสดงบนใบเสร็จธุรกรรม',
      tax_registration_number: 'เลขทะเบียนภาษี',
      tax_registration_number_placeholder: 'กรุณาใส่เลขทะเบียนภาษี',
      tax_registration_number_help: 'หมายเลขนี้จะแสดงบนใบเสร็จธุรกรรม',
      institution_type: 'ประเภทสถาบัน',
      institution_type_help: 'ประเภทนี้ใช้สำหรับรายงาน AMLO ต่อต้านการฟอกเงิน',
      institution_types: {
        money_changer: 'ผู้แลกเปลี่ยนเงิน',
        bank: 'ธนาคาร',
        financial_institution: 'สถาบันการเงิน',
        other: 'อื่นๆ'
      },
      website: 'เว็บไซต์บริษัท',
      website_placeholder: 'กรุณาใส่เว็บไซต์บริษัท',
      website_help: 'ตัวอย่าง: www.example.com',
      license_number: 'เลขที่ใบอนุญาต',
      license_number_placeholder: 'กรุณาใส่เลขที่ใบอนุญาต',
      license_number_help: 'เลขที่ใบอนุญาตประกอบธุรกิจหรือใบอนุญาตดำเนินงาน',
      amlo_institution_code: 'รหัสสถาบัน (AMLO)',
      amlo_institution_code_help: 'รหัส 3 หลักที่ธนาคารแห่งประเทศไทยกำหนด ใช้กรอกในช่องแรกของรายงาน',
      amlo_branch_code: 'รหัสสาขา (AMLO)',
      amlo_branch_code_help: 'รหัสสาขา 3 หลักสำหรับช่องที่สองของรายงาน AMLO',
      bot_sender_code: 'รหัสสถาบันผู้ส่งข้อมูล (BOT)',
      bot_sender_code_help: 'ตรงกับช่อง “รหัสสถาบันผู้ส่งข้อมูล” ในเทมเพลต BOT โดยทั่วไปเป็นตัวเลข 13 หลัก',
      bot_branch_area_code: 'รหัสพื้นที่สถานประกอบการ (BOT)',
      bot_branch_area_code_help: 'ตรงกับช่อง “เลขที่ หรือรหัสพื้นที่ของสถานประกอบการ” ในเทมเพลต BOT',
      bot_license_number: 'เลขที่ใบอนุญาต (BOT)',
      bot_license_number_help: 'ใช้เมื่อ BOT ต้องการเลขที่ใบอนุญาตเฉพาะ แยกจากเลขที่อื่น',
      status: {
        active: 'ใช้งาน',
        inactive: 'ไม่ใช้งาน'
      },
